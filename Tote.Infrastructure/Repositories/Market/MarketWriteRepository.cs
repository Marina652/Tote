...
{
    internal class MarketWriteRepository : IMarketWriter
    {
        ...
        public async ValueTask<Guid> WriteAsync(Application.Market.Common.Models.Market newMarket, CancellationToken token)
        {
            using (_dbConnection)
            {
        ...
        public async ValueTask UpdateAsync(Application.Market.Common.Models.Market newMarket, CancellationToken token)
        {
            using (_dbConnection)
            {
